<template>
    <v-app id="inspire">
        <Header />
        <v-content>
            <v-container class="fill-height pa-6" max-width="600px">
                <v-row justify="center" align="center">
                    <v-col class="text-center ">
                        <div width="100%" class="d-flex wrapper-form-coop">
                            <v-card class="pa-5 mr-5 wrapper-form">
                                ...
                                <div>
                                    <v-form ref="form">
                                        ...
                                        ></v-slider>
                                        <div
                                            class="d-flex wrapper-buttons mt-5"
                                        >
                                            ...
                                            <div class="button">
                                                <v-btn
                                                    :loading="loadingLastDate"
                                                    color="primary"
                                                    dense
                                                    width="100%"
                                                    @click="getLastUpdateDate"
                                                >
                                                    Актуальность базы
                                                </v-btn>
                                                <v-dialog
                        ...
                        <div
                            class="d-flex mt-12 wrapper-cards"
                            v-if="matches.length"
                        >
                            <CardMatches
                                :count="countMatches"
...
export default {
    ...
    methods: {
        ...
        searchByData: async function(data) {
            ...
            this.countMatches = data.countMatches;
            this.snackbar = true;
...
@media screen and (max-width: 768px) {
    ...
    .wrapper-cards .wrapper-card:last-child {
        margin-top: 40px;
    }
    .wrapper-form,
    .wrapper-coop,
